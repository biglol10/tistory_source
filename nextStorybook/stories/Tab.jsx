...
const TabHeader = ({ height, tabIndex, setTabIndex, children }) => {
  return (
    <>
      <div
...
const TabPanels = ({ tabIndex, opacityEffect = false, children }) => {
  return (
    <div
      className="tab-body"
      style={{
...
const TabPanel = ({ active, opacityEffect, children }) => {
  return (
    <div
      className={`${active && "active"}`}
      style={{
        ...
        transition: `${
          opacityEffect ? "opacity 200ms ease-in-out 0ms" : "none"
        }`,
      }}
    >
      {children}
